...
const SCAN_OPTIONS = [
  {
    label: 'Scan One Card',
    description: 'AI identify and price a single Pokémon, Magic, Lorcana, or Sports card.',
    icon: ScanLine,
    route: '/add',
  ...
  },
  {
    ...
    description: 'Photograph a full binder page — detect multiple cards at once.',
    icon: Layers,
    route: '/binder-scan',
  ...
  {
    label: 'Bulk Scanner',
    description: 'Upload multiple images and review in batches before importing.',
    icon: ImageIcon,
    route: '/bulk-scan',
  ...
  },
  {
    ...
    description: 'Guided six-view capture for Funko Pop! figures.',
    icon: Package,
  ...
  {
    label: 'Scan Coin',
    description: 'Obverse and reverse photos for coin identification.',
    icon: Coins,
  ...
  },
  {
    ...
    description: 'Cards, autographs, and sports memorabilia.',
    icon: Trophy,
