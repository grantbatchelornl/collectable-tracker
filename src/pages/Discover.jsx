...
export default function Discover() {
  return (
    <div className="px-4 py-4">
      ...
      <p className="text-sm text-muted-foreground mb-8">Browse public collections from collectors around the world.</p>
      <div className="text-center py-20">
        ...
        <p className="text-muted-foreground text-sm max-w-xs mx-auto">
          Public collector profiles, shared collections, and community discovery are on the way.
        </p>
